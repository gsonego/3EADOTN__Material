...
// Used by the /assistant endpoint to call Azure OpenAI (Module 6). Plain
// HttpClient on purpose -- no OpenAI SDK, see AssistantEndpoint.cs.
...
// Module 6: the AI feature. Everything about it lives in AssistantEndpoint.cs.
app.MapAssistant(titlesContainer);
...
{
    // v9: adds the POST /assistant endpoint -- Azure OpenAI, grounded on the
    // catalog in Cosmos DB (Module 6).
    public const string Value = "v9";
}
