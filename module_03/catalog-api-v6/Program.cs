...
{
    // v6: drops the connection string (and Key Vault) entirely for Cosmos DB --
    // the managed identity authenticates directly via RBAC (Module 3, 2.3).
    public const string Value = "v6";
}
